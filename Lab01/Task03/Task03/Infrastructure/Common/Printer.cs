namespace Task03.Infrastructure.Common;
...
internal static class Printer
{
    ...
    public static void Usage()
    {
        Console.WriteLine("""
                          ...
                          Formats:
                            counts:        "GRAM COUNT" per line, sorted by count desc then gram asc.
                            probabilities: "GRAM P" where P in (0,1], sum(P)=1, Culture=Invariant.
                          ...
                          Examples:
                            ...
                            dotnet run -- -i corpus.txt -b2 bigram_ref.txt
                            dotnet run -- -i corpus.txt -b1 mono_ref.txt -b4 quad_ref.txt

                            # chi-square test
                            dotnet run -- -i analyzed.txt -s -r2 bigram_ref.txt
